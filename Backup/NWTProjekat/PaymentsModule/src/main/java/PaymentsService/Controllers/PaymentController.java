...
public class PaymentController {
    ...
    public ResponseEntity<Void> createPayment(@RequestBody PaymentModel payment, UriComponentsBuilder ucBuilder) {
        System.out.println("Creating Payment " + payment.getSenderName());
...
//        }
        ...
        PaymentTypeModel paymentType = paymentTypeService.findOne(Integer.parseInt(payment.getType()));
        ...
        headers.setLocation(ucBuilder.path("/api/payments/{id}").buildAndExpand(payment.getId()).toUri());
